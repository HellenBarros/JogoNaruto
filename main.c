...
///iniciando
  ...
  BITMAP* vida[5];
  vida[0] = load_bitmap("vida_cheia.bmp", NULL);
  vida[1] = load_bitmap("vida_muita.bmp", NULL);
  vida[2] = load_bitmap("vida_metade.bmp", NULL);
  vida[3] = load_bitmap("vida_pouca.bmp", NULL);
  vida[4] = load_bitmap("vida_vazia.bmp", NULL);
